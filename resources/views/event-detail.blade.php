...
<main class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
    ...
    <div class="lg:col-span-1">
        <div class="sticky top-32">
            <img src="{{ ($event->poster_path && Storage::disk('public')->exists($event->poster_path)) ? asset('storage/' . $event->poster_path) : 'https://placehold.co/600x800' }}"
            ...
            <div class="mt-8 p-6 bg-white rounded-3xl border border-slate-100 shadow-sm">
                ...
                <div class="flex items-center gap-4">
                    <div class="w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center text-indigo-600 font-bold">
                        {{ strtoupper(substr($event->title, 0, 2)) }}</div>
                    <div>
    ...
    <div class="lg:col-span-2 space-y-12">
        ...
        <div class="prose prose-slate max-w-none">
            ...
            <p class="text-lg text-slate-600 leading-relaxed">
                {{ $event->description ?? 'Deskripsi untuk event ini belum tersedia.' }}
            </p>
        </div>
            ...
            <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                <div>
                    ...
                    <p class="mt-4 text-indigo-100 flex items-center gap-2">
                        ...
                        <span>Sisa stok: <span class="font-bold underline">{{ $event->stock }}</span> Tiket lagi!</span>
                    </p>
                </div>
                <div>
